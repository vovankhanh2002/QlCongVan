        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Hoten_NV = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DiaChi_NV = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SDT_NV = table.Column<int>(type: "int", nullable: true),
                    NgaySinh_NV = table.Column<DateTime>(type: "datetime2", nullable: true),
